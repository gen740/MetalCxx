...
if len(args.ninjatool) > 0:
    ...
    try:
        ninjaInvocation = subprocess.run(
            [args.ninjatool, "-t", "compdb"], cwd=args.builddir, capture_output=True
        )
        ...
        for fileCmd in ninjaCMDs:
            ...
            for cmdFile in filesInCmd:
                swiftCompilationCommands[cmdFile] = {
                    "file": cmdFile,
                    "command": cmd,
                    "directory": fileCmd["directory"],
                }
    except:
